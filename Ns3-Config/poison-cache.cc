...
//consumers
    //create1PreConsumers(0, alpha[1], reqRate[1], 5);
    create1PreConsumers(0, alpha2, reqRate[0], 1, 4, nFiles); //send interest packet

    //create1PreConsumers(5, alpha[1], reqRate[1], 2, 8, nFiles); //send data packet
    //create1PreConsumers(6, alpha[2], reqRate[2], 1, 8, othernFiles); //send data packet
