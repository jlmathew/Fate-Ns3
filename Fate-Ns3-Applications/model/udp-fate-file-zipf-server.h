...
/*
 * Copyright (c) 2019 James Mathewson 
 *
 ...
 */
#ifndef UDP_FATE_FILE_ZIPF_SERVER_H
#define UDP_FATE_FILE_ZIPF_SERVER_H
 ...
 */
class UdpFateFileZipfServer : public Application 
{
public:
  /**
  ...
  UdpFateFileZipfServer ();
  virtual ~UdpFateFileZipfServer ();
virtual void
