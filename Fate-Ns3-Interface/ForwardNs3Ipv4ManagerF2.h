...
#ifndef FORWARDNS3IPV4MANAGERBASEF2_H_
#define FORWARDNS3IPV4MANAGERBASEF2_H_
...
class ForwardNs3Ipv4ManagerF2 : public ForwardNs3Ipv4Manager 
{
  public:
  ForwardNs3Ipv4ManagerF2();

  ForwardNs3Ipv4ManagerF2(ConfigWrapper &config);
  virtual
  ~ForwardNs3Ipv4ManagerF2();
 ...
 // bool isThisMyIpAddr(const std::string &myName,  ns3::Ipv4Address addr) ;
  static const dataNameType_t &
   IdName(void) { static const dataNameType_t idName("ForwardNs3Ipv4ManagerF2"); return idName; }
bool
