 ...
 */
class FateIpv4Interface  : public Object
{
public:
  /**
  ...
  static bool 
  Ipv4ToFatePkt(Ptr<const Packet> p, uint16_t protocol, PktType &fatePkt)  ;


static bool
FatePktToIpv4(const PktType &fatePkt, Ptr< Packet> &p);
...
private:
  ...
  static uint16_t FatePort;
public:
  static uint16_t GetFateUniqPort() { return FatePort; }
  static void SetFateUniqPort(uint16_t port) {FatePort = port;}
protected:
