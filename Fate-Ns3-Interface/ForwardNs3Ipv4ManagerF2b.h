...
#ifndef FORWARDNS3IPV4MANAGERBASEF2B_H_
#define FORWARDNS3IPV4MANAGERBASEF2B_H_
...
class ForwardNs3Ipv4ManagerF2B : public ForwardNs3Ipv4Manager 
{
  public:
  ForwardNs3Ipv4ManagerF2B();

  ForwardNs3Ipv4ManagerF2B(ConfigWrapper &config);
  virtual
  ~ForwardNs3Ipv4ManagerF2B();
 ...
 // bool isThisMyIpAddr(const std::string &myName,  ns3::Ipv4Address addr) ;
  static const dataNameType_t &
   IdName(void) { static const dataNameType_t idName("ForwardNs3Ipv4ManagerF2B"); return idName; }
bool
