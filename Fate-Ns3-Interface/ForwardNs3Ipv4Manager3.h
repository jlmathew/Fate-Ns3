...
#ifndef FORWARDNS3IPV4MANAGERBASE3_H_
#define FORWARDNS3IPV4MANAGERBASE3_H_
...
class ForwardNs3Ipv4Manager3 : public ModuleManager
{
  public:
  ForwardNs3Ipv4Manager3();

  ForwardNs3Ipv4Manager3(ConfigWrapper &config);
  virtual
  ~ForwardNs3Ipv4Manager3();
...
virtual void
  ...
  static const dataNameType_t &
   IdName(void) { static const dataNameType_t idName("ForwardNs3Ipv4Manager3"); return idName; }
